...
export const PaginaLogin = () => {
  ...
  const handleRecuperar = async () => {
    if (!correoRecuperacion) {
      mostrarError("Introduce tu correo electrónico para recuperar la contraseña");
      return;
    }
              ...
              <div className='cuerpo-form'>
                ...
                <div className='fila-form'>
                  ...
                  <button
                    type="button"
                    className="enlace"
                    style={{ border: "none", background: "none", padding: '0rem 2rem', color: "#007bff", cursor: "pointer" }}
              ...
              >
                ...
                >
                  ...
                  <button
                    ...
                    onMouseEnter={e => !cargandoRecuperacion && (e.currentTarget.style.backgroundColor = '#e6b851')}
                    onMouseLeave={e => !cargandoRecuperacion && (e.currentTarget.style.backgroundColor = '#FAC463')}
                  >
