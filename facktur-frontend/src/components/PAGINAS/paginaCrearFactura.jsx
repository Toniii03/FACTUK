                ...
                <form className="formulario-factura" onSubmit={handleSubmit}>
                    ...
                    <div className="fila-formulario">
                        <div className="grupo-campo">
                            ...
                            <input type="date" id="fechaEmision" name="fechaEmision" defaultValue={new Date().toISOString().split("T")[0]} className="input-fecha" />
                        </div>
                        <div className="grupo-campo">
                            <label htmlFor="fechaVencimiento">Fecha de Vencimiento</label>
                            <input type="date" id="fechaVencimiento" name="fechaVencimiento" required className="input-fecha" onChange={(e) => setFechaLimite(e.target.value)} />
                        </div>
                    </div>
                ...
                <div className="formulario-articulo">
                    ...
                    <div style={{ display: "flex", width: "100%", gap: "10px", justifyContent: "space-between" }}>
                        <div className="grupo-campo">
                            ...
                            <input type="text" id="nombre" name="nombre" placeholder="Artículo" value={nuevoArticulo.nombre} onChange={handleChangeArticulo} required />
                        </div>

                        <div className="grupo-campo">
                            <label htmlFor="cantidad">Cantidad</label>
                            <input type="number" id="cantidad" name="cantidad" placeholder="Cantidad" value={nuevoArticulo.cantidad} onChange={handleChangeArticulo} required min="1" />
                        </div>

                        <div className="grupo-campo">
                            <label htmlFor="precio">Precio Unitario</label>
                            <input type="number" id="precio" name="precio" placeholder="Precio unitario" value={nuevoArticulo.precio} onChange={handleChangeArticulo} required min="0.00" step="0.5" />
                        </div>
                                ...
                                <tbody>
                                    {articulos.map((art, index) => (
                                        <tr key={index}>
                                            ...
                                            <td>{(art.cantidad * art.precio).toFixed(2)} €</td>
                                            <td>
                    ...
                    <p className="total-factura">
                        Total de la factura: {articulos.reduce((acc, art) => acc + art.cantidad * art.precio, 0).toFixed(2)} €
                    </p>
                </div>
